...
var image3 = new Uint8Array(nSlices*texSize*texSize);
/*
var max = data[0];
var min = data[0];
...
for(var k=0; k<nSlices; k++)
  for(var i=0; i<texSize; i++)
    for(var j=0; j<texSize; j++)  {
               image3[(i+texSize*j+texSize*texSize*k)] = data[i+texSize*j+texSize*texSize*k] ;
   }
...
function init() {
    ...
    gl.texImage3D(gl.TEXTURE_3D, 0, gl.LUMINANCE, texSize, texSize, nSlices, 0,
